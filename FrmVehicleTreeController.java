...
import ni.edu.uni.programacion.views.FrmVehicleTree;
import ni.edu.uni.programacion.views.panels.PnlVehicleTree;
...
public class FrmVehicleTreeController {
    ...
    private PnlVehicleTree pnlVehicletTree;
    ...
    public void initComponet() throws IOException{
        ...
        frmVehicleTree.getBtnAdd().addActionListener((ActionEvent evt)->{
            try {
                btnAddActionPerformed(evt);
            } catch (IOException ex) {
                Logger.getLogger(FrmVehicleTreeController.class.getName()).log(Level.SEVERE, null, ex);
            }
        });
