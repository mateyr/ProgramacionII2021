...
public class NewContactoController implements Initializable {
    ...
    public  void SetContac(Contacto cont){
       this.contacto = cont;
       txtFirstName.setText(cont.getFirstName());
       txtLastName.setText(cont.getLastName());
       txtAdress.setText(cont.getStreet());
       txtCountry.setText(cont.getCity().get());
       txtPostalCode.setText(Integer.toString(cont.getPostalCode().get()));
       //txtBirthday.setText(cont.getBirthday().get().toString());
